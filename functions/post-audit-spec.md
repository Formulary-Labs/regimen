...
structured_output_schema: config/schemas/post-audit-feed-forward.schema.json
---
...
**Schema:** `config/schemas/post-audit-feed-forward.schema.json` (version 1.0) — load that file for the authoritative field definitions and constraints.
