...
Produce a quarterly business review that synthesizes narrative intelligence across all active programs — cross-program patterns, trend analysis, and strategic recommendations not visible in any single program view.

## Steps

1. Read `engine/portfolio-qbr-spec.md` in full
2. Execute the spec with the parameters below
