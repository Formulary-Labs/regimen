...
Draft a stakeholder status update for a program, calibrated to the specified audience.
...
1. Apply constitution channel calibration (Article IV.15) and format-to-information-type (Article IV.13)
...
Flag the draft: `[DRAFT — REQUIRES LEAD PROGRAM MANAGER REVIEW BEFORE SENDING]`
