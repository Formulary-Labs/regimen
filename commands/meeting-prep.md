...
Prepare a focused briefing for a 1:1 or team meeting with a specific person, scoped to their responsibilities on a program over a date range.
...
3. Filter all items where `owner` matches the provided name (case-insensitive partial match)
4. Scope to items created, modified, or due within the last [days] days
