...
ENTRY_SCHEMA = {
    ...
    "quality_gate":   "pass | failed_once_corrected | escalated | skipped | not_applicable",
...
OUTPUT_TYPES = [
    ...
    "product_onboarding_package", # validated onboarding kit package merged into program
...
def main():
    ...
    wp.add_argument("--quality-gate", dest="quality_gate", default="pass",
                    choices=["pass", "failed_once_corrected", "escalated", "skipped", "not_applicable"],
